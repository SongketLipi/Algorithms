...
public class SieveOfEratosthenes {
    ...
    private static void MarkNonPrimes(int number) {
        ...
        // We need to mark the mutiples of each prime found upto root(N) ; +1 to play
        // safe
        ...
        for (int i = 3; i <= number;
            ...
            if (!mark[i]) {
                ...
                if (
                // We don't need mark the multiple of a prime number that is greater than
                // root(N)
                i <= limit)
    ...
    public static void main(String[] args) {
        ...
        if (
        /*
         * Don't do `!mark[number]` because we did not mark the multiple's of 2, as well
         * as checked Odds only. We skipped it to save computation time.
         * 
         */
