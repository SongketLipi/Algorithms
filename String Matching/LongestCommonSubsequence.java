...
public class LongestCommonSubsequence {
    ...
    private static int GetLCSLength(int stringALength, int stringBlength) {
        ...
        if (stringACharacters[stringALength - 1] == stringBCharacters[stringBlength - 1])
            ...
            return max(GetLCSLength(stringALength, stringBlength - 1), GetLCSLength(stringALength - 1, stringBlength));
    }
    ...
    private static boolean IsSubsequence(int stringALength, int stringBlength) {
        return (GetLCSLength(stringALength, stringBlength) == stringBlength) ? true : false;
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Is String 2 a Subsequence of String 1 : " + IsSubsequence(stringALength, stringBlength));
